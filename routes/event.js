...
router.post('/', middleware.auth.loggedIn,  (req, res, next) => {
    let promise;
    let params = [req.user, req.body.groupId, req.body.name, req.body.description, req.body.startTime, req.body.endTime, req.body.locationName, req.body.address, req.body.zipcode, req.body.city, req.body.country];
...
router.put('/:id', middleware.auth.loggedIn, (req, res, next) => {
    eventService.updateEvent(req.user, req.params.id, req.body.name, req.body.description, req.body.startTime, req.body.endTime, req.body.locationName, req.body.address, req.body.zipcode, req.body.city, req.body.country, req.body.pollDates)
    .then(event => res.send(event))
    .catch(next);
});
